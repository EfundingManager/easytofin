...
## Phase 6.6: TOTP Authenticator App Implementation
- [ ] Install TOTP library (speakeasy or similar)
- [ ] Update database schema to store TOTP secret and backup codes
- [ ] Create TOTP setup endpoint with QR code generation
- [ ] Create TOTP verification endpoint
- [ ] Create TOTP setup UI page with QR code display
- [ ] Create TOTP verification UI page
- [ ] Update 2FA flow to use TOTP for admin/manager/staff/support roles
- [ ] Test end-to-end TOTP flow with authenticator app


## Phase 6.7: TOTP Authenticator App Implementation
- [x] Create TOTP service with QR code generation and verification
- [x] Create database helpers for TOTP operations
- [x] Create TOTP backend router with setup and verification endpoints
- [x] Create TOTP setup UI page with QR code display
- [x] Create TOTP verification UI page for subsequent logins
- [x] Add TOTP routes to App.tsx
- [ ] Update phone auth flow to redirect to TOTP for privileged roles
- [ ] Update email auth flow to redirect to TOTP for privileged roles
- [ ] Update Gmail auth flow to redirect to TOTP for privileged roles
- [ ] Test end-to-end TOTP flow with authenticator app
