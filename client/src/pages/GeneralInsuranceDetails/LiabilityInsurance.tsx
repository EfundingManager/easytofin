...
export default function LiabilityInsurance() {
  ...
  const translation = getDetailPageTranslation('liabilityInsurance', language as 'en' | 'zh' | 'pl');
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <div className="bg-gray-50 py-4 border-b">
        <div className="container flex justify-between items-center">
          <Link href="/services/general-insurance" className="inline-flex items-center gap-2 text-teal-600 hover:text-teal-700 font-semibold text-sm">
      ...
      <section className="py-16 bg-white">
        <div className="container max-w-3xl">
          ...
          <h1 className="font-[Outfit] font-700 text-3xl text-gray-900 mb-8">
            {translation?.title || 'LiabilityInsurance'}
          </h1>
