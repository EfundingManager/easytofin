...
export default function EmailBlasterPage() {
  const [activeTab, setActiveTab] = useState<string>("blaster");
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-muted-foreground">Send bulk emails and manage campaigns</p>
          </div>
        </div>
      </div>

      {/* Top-level tabs for Email Blaster vs Email Campaigns */}
      <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
        <TabsList className="grid w-full grid-cols-2 max-w-md">
          <TabsTrigger value="blaster">Email Blaster</TabsTrigger>
          <TabsTrigger value="campaigns">Email Campaigns</TabsTrigger>
        </TabsList>

        {/* Email Blaster Tab */}
        <TabsContent value="blaster" className="space-y-6">
          {/* Send Result Alert */}
          {sendResult && (
            ...
            <CardContent>
              <div className="rounded-lg border-2 border-dashed p-12 text-center">
                ...
                <p className="text-sm text-muted-foreground mb-6">
                  Create and schedule advanced email campaigns with SendGrid templates, scheduling, and analytics.
                </p>
