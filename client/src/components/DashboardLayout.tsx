...
import { LayoutDashboard, LogOut, PanelLeft, Users, Mail, Lock, UserCog } from "lucide-react";
...
const menuItems = [
  ...
  { icon: Lock, label: "Account Lockout", path: "/admin/account-lockout-management" },
];
